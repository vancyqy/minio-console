        ...
        <Grid container>
          <Grid item xs={12} sx={actionsTray.actionsTray}>
            ...
            sx={{
              ...
              errorProps={{ disabled: true }}>
                ...
                <TooltipWrapper
                tooltip={
                checkedGroups.length < 1 ? t("Please select Groups on which you want to apply Policies") :

                applyPolicy ? t("Select Policy") :

                permissionTooltipHelper(
                applyPolicyPermissions, t("apply policies to Groups"))}>
              ...
              errorProps={{ disabled: true }}>
                ...
                <TooltipWrapper
                tooltip={
                checkedGroups.length === 0 ? t("Select Groups to delete") :

                getGroup ? t("Delete Selected") :

                permissionTooltipHelper(
                getGroupPermissions, t("delete Groups"))}>
          ...
          <Fragment>
            ...
            <Fragment>
                ...
                help={
                <Fragment>{t("A group can have one attached IAM policy, where all users with membership in that group inherit that policy. Groups support more simplified management of user permissions on the MinIO Tenant.")}
