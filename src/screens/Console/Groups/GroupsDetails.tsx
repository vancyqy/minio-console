...
const GroupsDetails = () => {
  ...
  const memberActionText = members.length > 0 ? t("Edit Members") : t("Add Members");
  ...
  function toggleGroupStatus(nextStatus: boolean) {
    ...
    updateGroup(params.groupName || "", {
      members: members,
      status: nextStatus ? t("enabled") : t("disabled")
    }).
    then(() => {
      fetchGroupInfo();
    }).
  ...
  onMouseMove={() => {
    ...
    sx={{
      ...
      errorProps={{ disabled: true }}>
        ...
        memberActionText :
        permissionTooltipHelper(
        createGroupPermissions, t("edit Group membership"))}>
      ...
      errorProps={{ disabled: true }}>
        ...
        "" :
        permissionTooltipHelper(
        viewUserPermissions, t("view User details"))}>
  ...
  <Fragment>
    ...
    onMouseMove={() => {
      ...
      <TooltipWrapper
      tooltip={
      canSetPolicies ? t("Set Policies") :

      permissionTooltipHelper(
      setGroupPoliciesPermissions, t("assign Policies"))}>
      ...
      <PageLayout>
        <Grid item xs={12}>
          ...
          sx={{
            ...
            "" :
            permissionTooltipHelper(
            enableDisableGroupPermissions, t("enable or disable Groups"))}>
