...
import { t } from "i18next";import React, { Fragment, useEffect, useState } from "react";
...
const HealthInfo = () => {
  ...
  return (
    <Fragment>
      <PageHeaderWrapper label={t("Health")} actions={<HelpMenu />} />
      ...
      <PageLayout>
            ...
            sx={{
              ...
              sx={{
                ...
                sx={{
                  ...
                  <Grid item xs={12}>
                        <strong>{t("Health report uploaded to SUBNET successfully!")}

                    </strong>
                        &nbsp;{" "}
                        <strong>{t("See the results on your")}
                      {" "}
                          <a href={subnetResponse}>{t("SUBNET Dashboard")}</a>{" "}
                        </strong>
                      </Grid>}
                  ...
                  serverDiagnosticStatus === DiagStatSuccess &&
                  <Grid item xs={12}>
                        <strong>{t("Something went wrong uploading your Health report to SUBNET.")}


                    </strong>
                        &nbsp;{" "}
                        <strong>{t("Log into your")}
                      {" "}
                          <a href="https://subnet.min.io">{t("SUBNET Account")}</a>{t("to manually upload your Health report.")}
        ...
        <Fragment>
            <br />
            <HelpBox
          title={t("Cluster Health Report will be uploaded to SUBNET, and is viewable from your SUBNET Diagnostics dashboard.")}


          iconComponent={<InfoIcon />}
          help={t("If the Health report cannot be generated at this time, please wait a moment and try again.")} />
