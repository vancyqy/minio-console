...
export const panelsConfiguration: IDashboardPanel[] = [
  ...
  {
    id: 52,
    title: t("Object size distribution"),
    data: [],
    widgetConfiguration: [
      {
        dataKey: "a",
  ...
  {
    id: 63,
    title: t("API Data Received Rate"),
    data: [],
    widgetConfiguration: [
      {
        dataKey: "",
  ...
  {
    id: 17,
    title: t("Internode Data Transfer"),
    data: [],
    widgetConfiguration: [
      {
        dataKey: "",
  ...
  {
    id: 80,
    title: t("Time Since Last Heal Activity"),
    data: "N/A",
    type: widgetType.simpleWidget,
    widgetIcon: <HealIcon />,
  ...
  {
    id: 81,
    title: t("Time Since Last Scan Activity"),
    data: "N/A",
    type: widgetType.simpleWidget,
  ...
  {
    id: 71,
    title: t("API Request Error Rate"),
    data: [],
    widgetConfiguration: [
      {
        dataKey: "",
