...
const PrDashboard = ({ apiPrefix = "admin", usage }: IPrDashboard) => {
  ...
  const prometheusTabs: TabItemProps[] = [
  {
    ...
    <Fragment>
        ...
        sx={{
          fontSize: "14px"
        }}>{t("It looks like Prometheus is not available or reachable at the moment.")}
    ...
    <Fragment>
        ...
        sx={{
          fontSize: "14px"
            ...
            <h2 style={{ margin: 0, borderBottom: "1px solid #dedede" }}>{t("Advanced")}
