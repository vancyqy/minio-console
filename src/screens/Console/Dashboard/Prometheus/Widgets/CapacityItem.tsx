...
}: {value: IDashboardPanel;timeStart: any;timeEnd: any;apiPrefix: string;}) => {
    ...
    <CapacityItemMain>
      ...
      sx={{
        ...
        sx={{
          ...
          <br />
          <Box className={"usableLabel"}>{t("Free")}</Box>
        </Box>
      ...
      sx={{
        ...
        <Box>
          ...
          <Box className={"ofUsed"}>
            <div className="value">{t("Of:")}{niceBytesInt(totalUsable)}</div>
          </Box>
        </Box>
