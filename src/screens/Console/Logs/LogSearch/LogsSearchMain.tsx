...
const LogsSearchMain = () => {
  ...
  return (
    <Fragment>
      ...
      <PageHeaderWrapper label={t("Audit Logs")} actions={<HelpMenu />} />
        ...
        <Fragment>
            ...
            sx={{
              ...
              [`@media (max-width: ${breakPoints.lg}px)`]: {
                ...
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <ExpandOptionsButton
                label={`${filterOpen ? t("Hide") : t("Show")} advanced Filters`}
                open={filterOpen}
                onClick={() => {
            ...
            sx={{
              ...
              sx={{
                ...
                <br />{t("You can use '*' to match any character, '.' to signify a single character or '\\' to scape an special character (E.g. mybucket-*)")}
