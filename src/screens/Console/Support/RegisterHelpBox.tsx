...
}: {icon: any;description: string | React.ReactNode;}) => {
  return (
    <Box
    sx={{
      display: "flex",
...
const RegisterHelpBox = () => {
  return (
    ...
    help={
    <Fragment>
          <Box sx={{ fontSize: "14px", marginBottom: "15px" }}>{t("Registering this cluster with the MinIO Subscription Network (SUBNET) provides the following benefits in addition to the commercial license and SLA backed support.")}
      ...
      sx={{
        ...
        description={
        <a href="https://min.io/signup?ref=con" target="_blank">{t("More Features")}
