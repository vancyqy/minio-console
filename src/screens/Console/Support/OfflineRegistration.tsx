  ...
  return (
    <Fragment>
      ...
      sx={{
        ...
        <FormLayout
        title={t("Register cluster in an Air-gap environment")}
            ...
            "& .step-row": {
              ...
              <Box>
                <Box className="step-row">
                  <Box className="step-text">{t("Click on the link to register this cluster in SUBNET and get a License Key for this Air-Gap deployment")}
              ...
              sx={{
                marginTop: "25px"
              }}>{t("Note: If this machine does not have internet connection, Copy paste the following URL in a browser where you access SUBNET and follow the instructions to complete the registration")}
              ...
              sx={{
                ...
                flexDirection: "column"
                  ...
                  <label style={{ fontWeight: "bold", marginBottom: "10px" }}>{t("Paste the License Key")}
                  {" "}
                  </label>
                  <CommentBox
                value={licenseKey}
