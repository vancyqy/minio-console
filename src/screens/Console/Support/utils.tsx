    ...
    <Fragment>
      ...
      <Grid item xs={12} sx={{ marginTop: 25 }}>
        ...
        sx={{
          ...
          {" "}
          <a href="https://subnet.min.io" target="_blank">{t("SUBNET")}

          </a>{" "}{t("to avail support for this MinIO cluster")}
      ...
      sx={{
        ...
        sx={{
          ...
          sx={{
            ...
            <SettingsIcon />
            <div style={{ marginLeft: "10px", fontWeight: 600 }}>{t("Proxy Configuration")}
          ...
          sx={{
            ...
            target="_blank">{t("configure a proxy")}


            </a>{" "}{t("to connect to SUBNET .")}
