...
const CallHome = () => {
  ...
  return (
    <Fragment>
      ...
      <PageHeaderWrapper label={t("Call Home")} actions={<HelpMenu />} />
      <PageLayout>
        {!clusterRegistered && <RegisterCluster compactMode />}
        <FormLayout
        helpBox={
        <HelpBox
        title={t("Learn more about Call Home")}
        ...
        <Fragment>
          ...
          sx={{
            ...
            marginTop: "10px"
                    ...
                    <Box>{t("Enabling Call Home sends cluster health & status to your registered MinIO Subscription Network account every 24 hours.")}



              <br />
                      <br />{t("This helps the MinIO support team to provide quick incident responses along with suggestions for possible improvements that can be made to your MinIO instances.")}



              <br />
                      <br />{t("Your cluster must be")}
              {" "}
                      <Link to={"/support/register"}>{t("registered")}</Link>{t("in the MinIO Subscription Network (SUBNET) before enabling this feature.")}
          ...
          <Fragment>
            ...
            sx={{
              ...
              disabled={loading || !clusterRegistered}>{t("Disable Call Home")}
              ...
              disabled={loading || !clusterRegistered}>{t("Save Configuration")}
