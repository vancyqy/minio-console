...
}: {volumeVal: string;pathVal: string;}) => {
  return (
...
const Inspect = () => {
  ...
  return (
    <Fragment>
      <PageHeaderWrapper label={t("Inspect")} actions={<HelpMenu />} />
      ...
      <PageLayout>
          ...
          sx={{
            ...
            "& .spacer": {
              marginBottom: "5px"
                      ...
                      <Box>
                        <Box className="step-row">
                          <div className="step-text">{t("To Download 'xl.meta' for a specific object from all the drives in a zip file:")}
              ...
              volumeVal={`test-bucket`} />
                      ...
                      <Box>
                        <Box className="step-row">
                          <div className="step-text">{t("To Download all constituent parts for a specific object, and optionally encrypt the downloaded zip:")}
              ...
              volumeVal={`test*/*/part.*`} />
                      ...
                      <Box>
                        <Box className="step-row">
                          <div className="step-text">{t("To Download recursively all objects at a prefix.")}

                  <br />{t("NOTE: This can be an expensive operation use it with caution.")}
        ...
        titleIcon={<PasswordKeyIcon />}>
            ...
            <Fragment>
              <Box>{t("This will be displayed only once. It cannot be recovered.")}

              <br />{t("Use secure medium to share this key.")}
