    ...
    <Grid container>
      <Grid item xs={12}>
        <Grid container sx={{ display: "flex", alignItems: "center" }}>
          <HelpTip
          content={
          <Fragment>{t("Define which actions are permitted on a specified resource. Learn more about")}

            {" "}
                <a
            target="blank"
            href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition.html">{t("IAM conditional statements")}
          ...
          placement="right">
            ...
            <Grid item xs={12} sm={6} sx={{ fontWeight: "bold" }}>{t("Statements")}
      ...
      {!policyStatements && <Fragment>{t("Policy has no statements")}</Fragment>}
      {policyStatements &&
      <Grid
      item
      xs={12}
