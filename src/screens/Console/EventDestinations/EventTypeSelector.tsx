    ...
    <Fragment>
      ...
      <PageLayout>
        <FormLayout helpBox={<NotificationEndpointTypeSelectorHelpBox />}>
          <Box>
            <Box sx={{ fontSize: 16, fontWeight: 600, paddingBottom: 15 }}>{t("Queue")}
            ...
            <Box sx={{ fontSize: 16, fontWeight: 600, paddingBottom: 15 }}>{t("Database")}
            ...
            <Box sx={{ fontSize: 16, fontWeight: 600, paddingBottom: 15 }}>{t("Functions")}
