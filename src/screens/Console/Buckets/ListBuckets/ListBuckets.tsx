      ...
      <PageLayout>
        <Grid item xs={12} sx={actionsTray.actionsTray}>
          ...
          sx={{
            ...
            <Fragment>
              ...
              !hasBuckets ?
              "" :
              bulkSelect ? t("Unselect Buckets") : t("Select Multiple Buckets")}>
              ...
              !hasBuckets ?
              "" :
              selectedBuckets.length === filteredRecords.length ? t("Unselect All Buckets") : t("Select All Buckets")}>
              ...
              IAM_PERMISSIONS[IAM_ROLES.BUCKET_LIFECYCLE], t("configure lifecycle for the selected buckets")) :


              selectedBuckets.length === 0 ?
              bulkSelect ? t("Please select at least one bucket on which to configure Lifecycle") : t("Use the Select Multiple Buckets button to choose buckets on which to configure Lifecycle") : t("Set Lifecycle")}>
              ...
              "" :
              selectedBuckets.length === 0 ?
              bulkSelect ? t("Please select at least one bucket on which to configure Replication") : t("Use the Select Multiple Buckets button to choose buckets on which to configure Replication") : t("Set Replication")}>
            ...
            "" :
            permissionTooltipHelper(
            [IAM_SCOPES.S3_CREATE_BUCKET], t("create a bucket"))}>
        ...
        className={obOnly ? "isEmbedded" : ""}>
          ...
          <Grid container>
              ...
              title={t("No Results")}
              help={
              <Fragment>{t("No buckets match the filtering condition")}
          ...
          <Grid container>
              ...
              <Fragment>{t("MinIO uses buckets to organize objects. A bucket is similar to a folder or directory in a filesystem, where each bucket can hold an arbitrary number of objects.")}
                ...
                <Fragment>
                  ...
                  [
                  IAM_SCOPES.S3_LIST_BUCKET,
                  IAM_SCOPES.S3_ALL_LIST_BUCKET], t("view the buckets on this server"))}
