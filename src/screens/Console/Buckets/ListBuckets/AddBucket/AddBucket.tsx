  ...
  return (
    <Fragment>
      ...
      <PageLayout>
        ...
        title={t("Buckets")}
        help={
        <Fragment>{t("MinIO uses buckets to organize objects. A bucket is similar to a folder or directory in a filesystem, where each bucket can hold an arbitrary number of objects.")}



          <br />
                  <br />
                  <b>{t("Versioning")}</b>{t("allows to keep multiple versions of the same object under the same key.")}

          <br />
                  <br />
                  <b>{t("Object Locking")}</b>{t("prevents objects from being deleted. Required to support retention and legal hold. Can only be enabled at bucket creation.")}


          <br />
                  <br />
                  <b>{t("Quota")}</b>{t("limits the amount of data in the bucket.")}
          {lockingAllowed &&
          <Fragment>
                      <br />
                      <br />
                      <b>{t("Retention")}</b>{t("imposes rules to prevent object deletion for a period of time. Versioning must be enabled in order to set bucket retention policies.")}
          ...
          onSubmit={(e: React.FormEvent<HTMLFormElement>) => {
            ...
            <Box>
              ...
              <Box sx={{ marginTop: 10 }}>
                {!distributedSetup &&
                <Fragment>
                    <ErrorBox>{t("These features are unavailable in a single-disk setup.")}

                    <br />{t("Please deploy a server in")}
                    {" "}
                      <a
                    href="https://min.io/docs/minio/linux/operations/install-deploy-manage/deploy-minio-multi-node-multi-drive.html?ref=con"
                    target="_blank"
                    rel="noopener">{t("Distributed Mode")}


                    </a>{" "}{t("to use these features.")}
                ...
                <Fragment>
                  ...
                  sx={{
                    ...
                    "& > .min-icon ": {
                      ...
                      <InfoIcon />{t("Versioning setting cannot be changed as cluster replication is enabled for this site.")}
                ...
                <Fragment>
                  ...
                  <strong>
                          {" "}{t("You must disable Object Locking before Versioning can be disabled")}

                    <br />
                        </strong>}{t("MinIO supports keeping multiple")}
                  ...
                  target="blank">{t("versions")}


                  </a>{" "}{t("of an object in a single bucket.")}

                  <br />{t("Versioning is required to enable")}
                  {" "}
                      <a
                  href="https://min.io/docs/minio/macos/administration/object-management.html#object-retention"
                  target="blank">{t("Object Locking")}
                ...
                <Fragment>
                  ...
                  helpTip={
                  <Fragment>{t("You can choose to")}
                    {" "}
                          <a href="https://min.io/docs/minio/windows/administration/object-management/object-versioning.html#exclude-folders-from-versioning">{t("exclude folders and prefixes")}

                    </a>{" "}{t("from versioning if Object Locking is not enabled.")}

                    <br />{t("MinIO requires versioning to support replication.")}

                    <br />{t("Objects in excluded prefixes do not replicate to any peer site or remote site.")}
                ...
                <Fragment>
                      {retentionEnabled &&
                  <strong>
                          {" "}{t("You must disable Retention before Object Locking can be disabled")}

                    <br />
                        </strong>}{t("You can only enable")}
                  ...
                  </a>{" "}{t("when first creating a bucket.")}

                  <br />
                      <br />
                      <a href="https://min.io/docs/minio/windows/administration/object-management/object-versioning.html#exclude-folders-from-versioning">{t("Exclude folders and prefixes")}

                  </a>{" "}{t("options will not be available if this option is enabled.")}
                ...
                helpTip={
                <Fragment>{t("Setting a")}
                  {" "}
                      <a
                  href="https://min.io/docs/minio/linux/reference/minio-mc/mc-quota-set.html"
                  target="blank">{t("quota")}


                  </a>{" "}{t("assigns a hard limit to a bucket beyond which MinIO does not allow writes.")}
                ...
                label={t("Retention")}
                helpTip={
                <Fragment>{t("MinIO supports setting both")}
                  {" "}
                        <a
                  ...
                  target="blank">{t("bucket-default")}


                  </a>{" "}{t("and per-object retention rules.")}

                  <br />
                        <br />{t("For per-object retention settings, defer to the documentation for the PUT operation used by your preferred SDK.")}
                ...
                <Fragment>
                  ...
                  <Fragment>
                    ...
                    target="blank">{t("Compliance")}


                    </a>{" "}{t("lock protects Objects from write operations by all users, including the MinIO root user.")}
                    ...
                    target="blank">{t("Governance")}


                    </a>{" "}{t("lock protects Objects from write operations by non-privileged users.")}
            ...
            sx={{
              ...
              <TooltipWrapper
              tooltip={
              invalidFields.length > 0 || !isDirty || hasErrors ? t("You must apply a valid name to the bucket") :
