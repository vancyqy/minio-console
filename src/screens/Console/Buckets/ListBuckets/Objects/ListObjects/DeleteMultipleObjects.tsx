...
const DeleteObject = ({
      ...
      if (selectedObjects.length === 1) {
        ...
        then(onDelSuccess).
          ...
          setErrorSnackMessage({
            ...
            retentionConfig ? t("Please check retention mode and if object is WORM protected.") :
        ...
        bypassGovernance ? t("&bypass=true") : ""
        }`,
        toSend);
  ...
  return (
    ...
    onClose={onClose}
    confirmationContent={
    <Fragment>{t("Are you sure you want to delete the selected")}
      ...
      <Fragment>
        ...
        <Fragment>
          ...
          style={{
            ...
            color: "#c83b51"
          }}>{t("This will remove the objects as well as all of their versions,")}
