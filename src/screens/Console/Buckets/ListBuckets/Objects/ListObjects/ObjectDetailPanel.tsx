...
VersionsIcon } from
"mds";
import {ActionsList} from 'mds-dist'
import { api } from "api";
...
const ObjectDetailPanel = ({
  ...
  useEffect(() => {
    if (loadingObjectInfo && internalPaths !== "") {
      ...
      listObjects(bucketName, {
        ...
        // prefix: Base64.encode(internalPaths),
  ...
  const multiActionButtons = [
  {
    ...
    icon: <DownloadIcon />,
    tooltip: canGetObject ? t("Download this Object") :

    permissionTooltipHelper(
    [IAM_SCOPES.S3_GET_OBJECT, IAM_SCOPES.S3_GET_ACTIONS], t("download this object"))
  ...
  },
  {
    ...
    disabled: !!actualInfo.is_delete_marker || !canGetObject,
    icon: <ShareIcon />,
    tooltip: canGetObject ? t("Share this File") :

    permissionTooltipHelper(
    [IAM_SCOPES.S3_GET_OBJECT, IAM_SCOPES.S3_GET_ACTIONS], t("share this object"))
  ...
  },
  {
    ...
    icon: <PreviewIcon />,
    tooltip: canGetObject ? t("Preview this File") :

    permissionTooltipHelper(
    [IAM_SCOPES.S3_GET_OBJECT, IAM_SCOPES.S3_GET_ACTIONS], t("preview this object"))
  ...
  },
  {
    ...
    locking ? t("Change Legal Hold rules for this File") : t("Object Locking must be enabled on this bucket in order to set Legal Hold") :


    permissionTooltipHelper(
    [IAM_SCOPES.S3_PUT_OBJECT_LEGAL_HOLD, IAM_SCOPES.S3_PUT_ACTIONS], t("change legal hold settings for this object"))
  ...
  },
  {
    ...
    locking ? t("Change Retention rules for this File") : t("Object Locking must be enabled on this bucket in order to set Retention Rules") :
    ...
    IAM_SCOPES.S3_PUT_OBJECT_RETENTION,
    IAM_SCOPES.S3_GET_ACTIONS,
    IAM_SCOPES.S3_PUT_ACTIONS], t("change Retention Rules for this object"))
  ...
  },
  {
    ...
    icon: <TagsIcon />,
    tooltip: canSetTags ? t("Change Tags for this File") :
    ...
    IAM_SCOPES.S3_GET_ACTIONS,
    IAM_SCOPES.S3_PUT_ACTIONS], t("set Tags on this object"))
  ...
  },
  {
    ...
    tooltip: canInspect ? t("Inspect this file") :

    permissionTooltipHelper(
    [IAM_SCOPES.ADMIN_INSPECT_DATA], t("inspect this file"))
  ...
  },
  {
    ...
    label: versionsMode ? t("Hide Object Versions") : t("Display Object Versions"),
    icon: <VersionsIcon />,
    disabled:
    !distributedSetup ||
    ...
    actualInfo.version_id && actualInfo.version_id !== "null" ? t("Display Versions for this file") :
    ...
    IAM_SCOPES.S3_GET_OBJECT_VERSION,
    IAM_SCOPES.S3_GET_ACTIONS,
    IAM_SCOPES.S3_PUT_ACTIONS], t("display all versions of this object"))
  ...
  return (
    <Fragment>
      ...
      sx={{
        ...
        "" :
        permissionTooltipHelper(
        [IAM_SCOPES.S3_DELETE_OBJECT], t("delete this object"))}>
          ...
          sx={{ justifyContent: "center", display: "flex" }}>
            ...
            errorProps={{ disabled: true }}>
              ...
              label={`${t('Delete')}${selectedVersion !== "" ? t("version") : ""}`} />
          ...
          resource={bucketName}>
              ...
              <Fragment>
                ...
                <Fragment>
                  ...
                  actualInfo.retention_mode.toLowerCase() : t("None")}
