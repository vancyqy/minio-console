...
import {
selDistSet,
setModalErrorSnackMessage } from
"../../../../../../systemSlice";
  ...
  return (
    <Fragment>
      ...
      titleIcon={deleteEnabled ? <DisabledIcon /> : <EditTagIcon />}>
        ...
        <Fragment>
            <Grid container>
              {tagsFor(false)}{t("Are you sure you want to delete the tag")}
            {" "}
              <DeleteTag>
        ...
        <Box>
          ...
          resource={bucketName}>
            ...
            sx={{
              ...
              sx={{
                ...
                <span className={"muted"}>{t("There are no tags for this object")}
          ...
          errorProps={{ disabled: true, onClick: null }}>
              ...
              <Box>
                <SectionTitle icon={<AddNewTagIcon />} separator={false}>{t("Add New Tag")}
