...
const PreviewFile = ({
  ...
  if (actualInfo) {
    ...
    path = `${window.globalConfig.baseUrlDownload}/api/v1/buckets/${encodeURIComponent(bucketName)}/objects/download?preview=true&prefix=${encodeURIComponent(actualInfo.name || "")}`;
    ...
    <Fragment>
      ...
      sx={{
        ...
        <div className={`iframeBase ${loading ? "iframeHidden" : ""}`}>
          ...
          onLoad={iframeLoaded}>{t("File couldn't be loaded. Please try Download instead")}
