...
formFieldStyles,
modalBasic,
modalStyleUtils } from
"../../Common/FormComponents/common/styleLibrary";
          ...
          <Grid item xs={12} sx={modalBasic.formScrollable}>
            ...
            sx={{
              ...
              <Fragment>
                    <a
                target="blank"
                href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference-arns.html">{t("Amazon Resource Name")}
