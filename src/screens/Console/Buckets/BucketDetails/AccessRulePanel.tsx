...
import { AddIcon, Button, SectionTitle, HelpTip } from "mds";
  ...
  return (
    <Fragment>
      ...
      errorProps={{ disabled: true }}>
        ...
        <HelpTip
        content={
        <Fragment>{t("Setting an")}
          {" "}
              <a
          href="https://min.io/docs/minio/linux/reference/minio-mc/mc-anonymous-set.html"
          target="blank">{t("Anonymous")}


          </a>{" "}{t("policy allows clients to access the Bucket or prefix contents and perform actions consistent with the specified policy without authentication.")}



        </Fragment>}

        placement="right">{t("Anonymous Access")}
