      ...
      errorProps={{ disabled: true }}>
        ...
        <Fragment>{t("MinIO")}
          {" "}
              <a
          target="blank"
          href="https://min.io/docs/minio/kubernetes/upstream/administration/monitoring.html">{t("bucket notifications")}


          </a>{" "}{t("allow administrators to send notifications to supported external services on certain object or bucket events.")}


        </Fragment>}

        placement="right">{t("Events")}
