        ...
        addRecord();
          ...
          <Fragment>{t("Select")}
            {" "}
                  <a
            target="blank"
            href="https://min.io/docs/minio/kubernetes/upstream/administration/object-management/create-lifecycle-management-expiration-rule.html">{t("Expiry")}


            </a>{" "}{t("to delete Objects per this rule. Select")}
            {" "}
                  <a
            target="blank"
            href="https://min.io/docs/minio/kubernetes/upstream/administration/object-management/transition-objects-to-minio.html">{t("Transition")}


            </a>{" "}{t("to move Objects to a remote storage")}
            {" "}
                  <a
            target="blank"
            href="https://min.io/docs/minio/windows/administration/object-management/transition-objects-to-minio.html#configure-the-remote-storage-tier">{t("Tier")}
          ...
          helpTip={
          <Fragment>{t("Select whether to apply the rule to current or non-current Object")}
          ...
          <Fragment>
              ...
              <HelpTip
              content={
              <Fragment>{t("Select to set expiry by days or newer noncurrent versions")}
          ...
          options={tiersList}
          helpTip={
          <Fragment>{t("Configure a")}
            {" "}
                    <a
            href={IAM_PAGES.TIERS_ADD}
            color="secondary"
            style={{ textDecoration: "underline" }}>{t("remote tier")}


            </a>{" "}{t("to receive transitioned Objects")}
