...
import { accessPolicyMap } from "api/consoleApi";
  ...
  return (
    <Fragment>
      ...
      <Fragment>
            <TooltipWrapper
        tooltip={
        canBrowse ? t("Browse Bucket") :

        permissionTooltipHelper(
        IAM_PERMISSIONS[IAM_ROLES.BUCKET_VIEWER], t("browsing this bucket"))}>
      ...
      <PageLayout>
        ...
        resource={bucketName}>
          ...
          style={{
            ...
            textTransform: "capitalize"
                ...
                {accessPolicyMap.find(item=>item.value === bucketInfo?.access) ? accessPolicyMap.filter(item=>item.value === bucketInfo?.access)?.map((it:any)=> t(it.label))[0] : bucketInfo?.access?.toLowerCase()}
              </span>
            </SecureComponent>}
        ...
        <Fragment>
          ...
          errorProps={{ disabled: true }}>
            ...
            IAM_SCOPES.S3_FORCE_DELETE_BUCKET], t("deleting this bucket"))}>
