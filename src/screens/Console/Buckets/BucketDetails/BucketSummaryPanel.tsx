...
const BucketSummary = () => {
  ...
  return (
    <Fragment>
      ...
      <SectionTitle separator sx={{ marginBottom: 15 }}>{t("Summary")}
      ...
      <Grid container>
            ...
            <Box sx={twoColCssGridLayoutConfig}>
              <Box sx={twoColCssGridLayoutConfig}>
                ...
                resource={bucketName}>
                  ...
                  value={accessPolicyMap.find(item=>item.value === accessPolicy)?.label || accessPolicy.toLowerCase()}
                  onEdit={() => {
                  ...
                  helpTip={
                  <Fragment>
                        <strong>{t("Private")}</strong>{t("policy limits access to credentialled accounts with appropriate permissions")}

                    <br />
                        <strong>{t("Public")}</strong>{t("policy anyone will be able to upload, download and delete files from this Bucket once logged in")}


                    <br />
                        <strong>{t("Custom")}</strong>{t("policy can be written to define which accounts are authorized to access this Bucket")}

                    <br />
                        <br />{t("To allow Bucket access without credentials, use the")}
                    {" "}
                        <a href={`/buckets/${bucketName}/admin/prefix`}>{t("Anonymous")}
                ...
                resource={bucketName}>
                  ...
                  helpTip={
                  <Fragment>{t("MinIO supports enabling automatic")}
                    {" "}
                        <a
                    ...
                    target="blank">{t("SSE-S3")}


                    </a>{" "}{t("encryption of all objects written to a bucket using a specific External Key (EK) stored on the external KMS.")}
        ...
        resource={bucketName}>
            ...
            <Grid item xs={12} sx={{ marginTop: 5 }}>
              <SectionTitle separator sx={{ marginBottom: 15 }}>{t("Versioning")}
        ...
        resource={bucketName}>
            ...
            <Grid item xs={12} sx={{ marginTop: 5 }}>
              <SectionTitle separator sx={{ marginBottom: 15 }}>{t("Retention")}
              ...
              <Box sx={twoColCssGridLayoutConfig}>
                ...
                <Fragment>{t("MinIO")}
                  {" "}
                        <a
                  target="blank"
                  href="https://min.io/docs/minio/macos/administration/object-management.html#object-retention">{t("Object Locking")}


                  </a>{" "}{t("enforces Write-Once Read-Many (WORM) immutability to protect versioned objects from deletion.")}
