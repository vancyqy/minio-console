...
import {  SectionTitle, Tabs, HelpTip } from "mds";
  ...
  return (
    <Fragment>
      <SectionTitle separator>
        <HelpTip
        content={
        <Fragment>{t("Understand which")}
          {" "}
              <a
          target="blank"
          href="https://min.io/docs/minio/linux/administration/identity-access-management/policy-based-access-control.html#">{t("Policies")}
          ...
          {" "}
              <a
          target="blank"
          href="https://min.io/docs/minio/linux/administration/identity-access-management/minio-user-management.html">{t("Users")}


          </a>{" "}{t("are authorized to access this Bucket.")}

        </Fragment>}

        placement="right">{t("Access Audit")}
