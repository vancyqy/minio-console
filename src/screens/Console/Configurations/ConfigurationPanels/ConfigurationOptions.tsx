...
const ConfigurationOptions = () => {
  ...
  return (
    <Fragment>
      <PageHeaderWrapper label={t("Configuration")} actions={<HelpMenu />} />
      <PageLayout>
        ...
        <Grid item xs={12} sx={{ paddingTop: "15px" }}>
          ...
          help={
          <Fragment>{t("MinIO supports a variety of configurations ranging from encryption, compression, region, notifications, etc.")}
