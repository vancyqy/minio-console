...
const DeleteTierConfirmModal = ({
  ...
  return (
    ...
    confirmationContent={
    <React.Fragment>{t("Are you sure you want to delete the tier")}
      <strong>{tierName}</strong>?
          <br />
          <br />
          <strong>{t("Please note")}</strong>
          <br />{t("Only empty tiers can be deleted. If the tier has had objects transitioned into it, it cannot be removed.")}
