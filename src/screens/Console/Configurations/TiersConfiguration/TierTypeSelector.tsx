  ...
  return (
    <Fragment>
      ...
      <PageLayout>
        ...
        title={t("Tier Types")}
        help={
        <Fragment>{t("MinIO supports creating object transition lifecycle management rules, where MinIO can automatically move an object to a remote storage \u201Ctier\u201D.")}



          <br />
                  <br />{t("MinIO supports the following Tier types:")}
          ...
          <br />
              ...
              target="_blank"
              rel="noopener">{t("MinIO or other S3-compatible storage")}
              ...
              target="_blank"
              rel="noopener">{t("Google Cloud Storage")}
              ...
              target="_blank"
              rel="noopener">{t("Microsoft Azure Blob Storage")}
