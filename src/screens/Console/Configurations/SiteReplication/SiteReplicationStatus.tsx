...
ApiError,
HttpResponse,
SiteReplicationStatusResponse } from
"api/consoleApi";
...
}: {maxValue: number;entityStatObj: Record<string, any>;entityTextPlural: string;icon?: React.ReactNode;}) => {
  ...
  return (
    <Fragment>
      ...
      <PageLayout>
        ...
        separator>{t("Replication status from all Sites")}
