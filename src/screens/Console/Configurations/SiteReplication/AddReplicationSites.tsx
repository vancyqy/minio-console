...
const TableHeader = () => {
  return (
    <React.Fragment>
      ...
      <Box>
        <InputLabel>{t("Access Key")}{"*"}</InputLabel>
      </Box>
      <Box>
        <InputLabel>{t("Secret Key")}{"*"}</InputLabel>
      </Box>
      <Box> </Box>
    </React.Fragment>);
      ...
      sx={{
        ...
        sx={{
          ...
          {currentSite.map((cs, index) => {
            const accessKeyError = isEmptyValue(cs.accessKey) ? t("AccessKey is required") :

            "";
            const secretKeyError = isEmptyValue(cs.secretKey) ? t("SecretKey is required") :
      ...
      sx={{
        ...
        sx={{
          ...
          {existingSites.map((ps, index) => {
            ...
            const accessKeyError = isEmptyValue(ps.accessKey) ? t("AccessKey is required") :

            "";
            const secretKeyError = isEmptyValue(ps.secretKey) ? t("SecretKey is required") :
    ...
    <Fragment>
      ...
      <PageLayout>
        ...
        sx={{
          ...
          <Box>
            <SectionTitle separator icon={<ClustersIcon />}>{t("Add Sites for Replication")}
            ...
            sx={{
              ...
              marginTop: "10px",
              marginBottom: "10px"
            }}>{t("Note: AccessKey and SecretKey values for every site is required while adding or editing peer sites")}
            ...
            sx={{
              ...
              "& li": {
                ...
                "&.step-text": {
                  ...
                  <Box>{t("The following changes are replicated to all other sites")}

              </Box>
                  <ul>
                    <li>{t("Creation and deletion of buckets and objects")}</li>
                    <li>{t("Creation and deletion of all IAM users, groups, policies and their mappings to users or groups")}


                </li>
                    <li>{t("Creation of STS credentials")}</li>
                    <li>{t("Creation and deletion of service accounts (except those owned by the root user)")}
                  ...
                  style={{
                    ...
                    style={{
                      paddingTop: "1px"
                    }}>{t("The following Bucket features will NOT be replicated")}
