...
const Speedtest = () => {
  ...
  return (
    <Fragment>
      <PageHeaderWrapper label={t("Performance")} actions={<HelpMenu />} />
      ...
      <PageLayout>
        ...
        resource={CONSOLE_UI_RESOURCE}>
              ...
              <Grid container>
                ...
                sx={{
                  ...
                  marginBottom: 8
                    ...
                    {start ?
                  <Fragment>{t("Speedtest in progress...")}
          ...
          <Fragment>
                <br />
                <HelpBox
            title={t("During the speed test all your production traffic will be temporarily suspended.")}
