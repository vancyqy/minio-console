      ...
      <Grid container sx={{ marginTop: 5 }}>
        <Grid item sm={12} md={6} lg={5} sx={{ padding: 10, paddingTop: 0 }}>
          ...
          sx={{
            ...
            <Box sx={{ padding: "10px 26px" }} withBorders>
              <Box sx={{ display: "flex" }}>
                <h4 style={{ margin: 0, marginBottom: 10, fontSize: 14 }}>{t("Users")}
            ...
            <Box sx={{ padding: "10px 26px" }} withBorders>
              <h4 style={{ margin: 0, marginBottom: 10, fontSize: 14 }}>{t("Groups")}
            ...
            <Box sx={{ padding: "10px 26px" }} withBorders>
              <h4 style={{ margin: 0, marginBottom: 10, fontSize: 14 }}>{t("Policies")}
        ...
        sx={{
          ...
          <Fragment>
            ...
            <Box sx={{ textAlign: "center" }}>{t("No query results yet")}</Box>}
