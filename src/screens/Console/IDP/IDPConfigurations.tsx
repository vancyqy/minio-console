...
import { AddIcon, Button, PageLayout, RefreshIcon, Grid } from "mds";
        ...
        then((res) => {
          ...
          if (res.data.results) {
            ...
            res.data.results.map((r: any) => {
              r.name = r.name === "_" ? t("Default") : r.name;
              r.enabled = r.enabled === true ? t("Enabled") : t("Disabled");
              return r;
            }));
        ...
        <Grid container>
          ...
          <Grid item xs={12}>
            ...
            errorProps={{ disabled: true }}>
              ...
              { label: t("Enabled"), elementKey: "enabled" }]}
