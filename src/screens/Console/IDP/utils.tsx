...
export const openIDFormFields = {
  config_url: {
    ...
    hasError: (s: string, editMode: boolean) => {
      return !s && editMode ? t("Config URL is required") : "";
    },
    label: "Config URL",
  ...
  client_id: {
    required: true,
    hasError: (s: string, editMode: boolean) => {
      return !s && editMode ? t("Client ID is required") : "";
    },
    label: "Client ID",
  ...
  client_secret: {
    required: true,
    hasError: (s: string, editMode: boolean) => {
      return !s && editMode ? t("Client Secret is required") : "";
    },
    label: "Client Secret",
...
export const ldapFormFields = {
  server_insecure: {
    required: true,
    hasError: (s: string, editMode: boolean) => {
      return !s && editMode ? t("Server Address is required") : "";
    },
  ...
  lookup_bind_dn: {
    required: true,
    hasError: (s: string, editMode: boolean) => {
      return !s && editMode ? t("Lookup Bind DN is required") : "";
    },
  ...
  lookup_bind_password: {
    required: true,
    hasError: (s: string, editMode: boolean) => {
      return !s && editMode ? t("Lookup Bind Password is required") : "";
    },
  ...
  user_dn_search_base_dn: {
    required: true,
    hasError: (s: string, editMode: boolean) => {
      return !s && editMode ? t("User DN Search Base DN is required") : "";
    },
  ...
  user_dn_search_filter: {
    required: true,
    hasError: (s: string, editMode: boolean) => {
      return !s && editMode ? t("User DN Search Filter is required") : "";
    },
