...
const CredentialsPrompt = ({
  ...
  return (
    ...
    titleIcon={<ServiceAccountCredentialsIcon />}>
      ...
      <Grid container>
        <Grid item xs={12}>{t("A new")}
          {entity}{t("has been created with the following details:")}
          {!idp && consoleCreds &&
          <Fragment>
              <Grid
            item
          ...
          {idp ?
          <WarningBlock>{t("Please Login via the configured external identity provider.")}

          </WarningBlock> :

          <WarningBlock>
              <WarnIcon />
              <span>{t("Write these down, as this is the only time the secret will be displayed.")}
        ...
        <Grid item xs={12} sx={{ ...modalStyleUtils.modalButtonBar }}>
          ...
          <Fragment>
              <TooltipWrapper
            tooltip={t("Download credentials in a JSON file formatted for import using mc alias import. This will only include the default login credentials.")}>
            ...
            <TooltipWrapper
            tooltip={t("Download all access credentials to a JSON file. NOTE: This file is not formatted for import using mc alias import. If you plan to import this alias from the file, please use the Download for Import button.")}>
