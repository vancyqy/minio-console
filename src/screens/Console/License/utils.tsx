...
export const LICENSE_PLANS_INFORMATION: LicensePlanOption[] = [
{
  ...
  planDescription:
  <span>{t("Designed for developers who are building open source applications in compliance with the GNU AGPL v3 license which requires developers to distribute their code under the same AGPL v3 license when they distribute, host or modify MinIO.")}
...
},
{
  ...
  planDescription:
  <span>{t("Designed for customers who require a commercial license and can mostly self-support but want the peace of mind that comes with an engineer-backend SLA, additional features and operational capabilities.")}
...
},
{
  ...
  planDescription:
  <span>{t("Designed for customers where a commercial license and the strictest,engineer-backed SLA are required. The Plus tiers offers additional features and operational capabilities, more interaction options and more enterprise deliverables.")}
