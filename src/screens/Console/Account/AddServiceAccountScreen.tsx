        ...
        <PageLayout>
          ...
          title={t("Create Access Key")}>
            ...
            onSubmit={(e: React.FormEvent<HTMLFormElement>) => {
              ...
              description={
              t("You can specify an optional JSON-formatted IAM policy to further restrict Access Key access to a subset of the actions and resources explicitly allowed for the parent user. Additional access beyond that of the parent user cannot be implemented through these policies.")} />
              ...
              <Grid item xs={12}>
                  ...
                  <Fragment>
                          <a
                    target="blank"
                    href="https://min.io/docs/minio/kubernetes/upstream/administration/identity-access-management/policy-based-access-control.html#policy-document-structure">{t("Guide to access policy structure")}
                  ...
                  placement="right">
                      ...
                      <PanelTitle>{t("Current User Policy - edit the JSON to remove permissions for this Access Key")}
