...
import { ConfirmDeleteIcon, InformativeMessage, Loader } from "mds";
  ...
  return (
    ...
    <Fragment>
      ...
      <Fragment>
        ...
        variant={"warning"}
        message={
        <Fragment>{t("Click on a user to view the full listing of associated Access Keys. All Access Keys associated with a user will be deleted along with the user.")}
