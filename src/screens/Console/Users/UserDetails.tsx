        ...
        <Grid container>
          <Grid item xs={12}>
            ...
            <Fragment>
              ...
              disableUserPermissions, t("disable users")) :
              ...
              permissionTooltipHelper(
              enableUserPermissions, t("enable users")) :


              permissionTooltipHelper(
              enableDisableUserPermissions, t("enable or disable users"))}>
              ...
              userLoggedIn === userName ? t("You cannot delete the currently logged in User") : t("Delete User") :


              permissionTooltipHelper(
              deleteUserPermissions, t("delete user"))}>
