        ...
        <Grid container>
          <Grid item xs={12} sx={actionsTray.actionsTray}>
            ...
            errorProps={{ disabled: true }}>
              ...
              checkedUsers.length === 0 ? t("Select Users to delete") : t("Delete Selected") :


              permissionTooltipHelper(
              [IAM_SCOPES.ADMIN_DELETE_USER], t("delete users"))}>
            ...
            errorProps={{ disabled: true }}>
              ...
              checkedUsers.length === 0 ? t("Select Users to group") : t("Add to Group") :


              permissionTooltipHelper(
              [IAM_SCOPES.ADMIN_ADD_USER_TO_GROUP], t("add users to groups"))}>
            ...
            errorProps={{ disabled: true }}>
              ...
              IAM_SCOPES.ADMIN_LIST_USER_POLICIES,
              IAM_SCOPES.ADMIN_LIST_GROUPS,
              IAM_SCOPES.ADMIN_ATTACH_USER_OR_GROUP_POLICY], t("create users"))}>
          ...
          <Fragment>
            ...
            <Fragment>
              ...
              help={
              <Fragment>{t("A MinIO user consists of a unique access key (username) and corresponding secret key (password). Clients must authenticate their identity by specifying both a valid access key (username) and the corresponding secret key (password) of an existing MinIO user.")}





                <br />{t("Groups provide a simplified method for managing shared permissions among users with common access patterns and workloads.")}



                <br />
                        <br />{t("Users inherit access permissions to data and resources through the groups they belong to.")}


                <br />{t("MinIO uses Policy-Based Access Control (PBAC) to define the authorized actions and resources to which an authenticated user has access. Each policy describes one or more actions and conditions that outline the permissions of a user or group of users.")}
                ...
                <br />
                        <br />{t("Each user can access only those resources and operations which are explicitly granted by the built-in role. MinIO denies access to any other resource or action by default.")}
