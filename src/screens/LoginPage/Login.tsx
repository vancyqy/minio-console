...
const Login = () => {
  ...
  switch (loginStrategy.loginStrategy) {
    ...
    default:
      ...
      sx={{
        ...
        <Fragment>
              <Box>
                <p style={{ textAlign: "center" }}>{t("An error has occurred")}

              <br />{t("The backend cannot be reached.")}
  ...
  return (
    <Fragment>
      ...
      sx={{
        "& .separator": {
          ...
          marginRight: 4
            ...
            <a href={docsURL} target="_blank" rel="noopener">{t("Documentation")}
      ...
      promoHeader={
      <span style={{ fontSize: 28 }}>{t("High-Performance Object Store")}</span>}

      promoInfo={
      <span style={{ fontSize: 14, lineHeight: 1 }}>{t("MinIO is a cloud-native object store built to run on any infrastructure - public, private or edge clouds. Primary use cases include data lakes, databases, AI/ML, SaaS applications and fast backup & recovery. MinIO is dual licensed under GNU AGPL v3 and commercial license. To learn more, visit")}




        {" "}
            <a href={"https://min.io/?ref=con"} target="_blank" rel="noopener">{t("www.min.io")}
